...
class Database {
    ...
    var $Database = "contactdb"; // Logical database name on that server.
...
//------------------------------------------- 
    ...
    function createDatabase($dbName, $sql) {
        ...
        if( $this->Link_ID != 0) {
            ...
            if($this->Query_ID) {
                echo "<p>[DB Created] ".$dbName."</p>";
                //mysql_close($this->Link_ID);
            }
        }
    }

    function createTable($dbName, $tableName, $sql) {
